...
class Favorites: UITableViewController {
    ...
    override func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        sectionView.setImage(UIImage(named: "favorite_icon_grn"), forState: UIControlState.Normal)
        sectionView.setTitle("FAVORITES", forState: UIControlState.Normal)
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
            ...
            performSegueWithIdentifier("favoriteVideoPlayback", sender: self)
    ...
    // helper func that convert coredata Entites to our DaraBase swift file Item Class object Array
